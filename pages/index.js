    ...
    return (
        <div className={styles.background}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="MakeTop platform is recommended by more than 1M customers since 2017. Get social signals for your account or online business with instant delivery"/>
                <meta name="og:description" content="MakeTop platform is recommended by more than 1M customers since 2017. Get social signals for your account or online business with instant delivery"/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="MakeTop #1 Site For Your Social Media Accounts"/>
                <meta property="title" content="MakeTop #1 Site For Your Social Media Accounts"/>
                ...
                <meta property="og:url" content="https://maketop.io/automatic-instagram-likes"/>
            ...
            <Layer type="link">
                <div className={`container`}>
                    <div className={styles.phone}>
                        ...
                        <img src="/mainPhotoChat.svg" alt="Views from maketop.io" className={styles.chat}/>
                        <img src="/mainPhotoLike.svg"  alt="Likes from maketop.io" className={styles.like}/>
                        <img src="/mainPhotoHeart.svg" alt="Followers from maketop.io"  className={styles.heart}/>
                        <img src="/mainPhoto1.svg" alt="Comments from maketop.io"   className={styles.photo1}/>
                        <img src="/mainPhoto2.svg" alt="Just maketop.io"  className={styles.photo2}/>
                        <img src="/mainPhoto3.svg" alt="Use maketop.io"  className={styles.photo3}/>
