    ...
    return (
        <div className={styles.background} style={{ background: "url('instagramBg.png') no-repeat 100%  ", backgroundSize: 'cover' }}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Buy Instagram likes from MakeTop. Cheap instant delivery to your profile. High rated likes and 100% quality. 24/7 Simple payment by crypto or credit card" />
                <meta name="og:description" content="Buy Instagram likes from MakeTop. Cheap instant delivery to your profile. High rated likes and 100% quality. 24/7 Simple payment by crypto or credit card" />
                <meta property="og:locale" content="en_US" />
                <meta property="og:type" content="article" />
                <meta property="og:title" content="Buy Instagram Likes Guaranteed by MakeTop #1 since 2017" />
                <meta property="title" content="Buy Instagram Likes Guaranteed by MakeTop #1 since 2017" />
                ...
                <meta property="og:url" content="https://maketop.io/buy-instagram-likes" />
                <link rel="canonical" href="https://maketop.io/automatic-instagram-likes" />
            </Head>
                    ...
                    <Layer type="link">
                        <div className={`container`}>
                            ...
                            <div className={styles.phone}>
                                <img src="/buyLikesPhoto.png" alt="Buy Instagram Likes" className={styles.instagramImg} />
                            ...
                            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                ...
                                {type[1] === 'active' ?
                                    ...
                                    <div className={buyLikesStyles.buyLikes_item_container}>
                                        ...
                                        {price["Auto-Likes Subs"]?.plans.map((item, index) => <BuyLikes key={item?.count}
                                            likes={item?.count}
                                            newPrice={item?.price}
                                            color="#285FFF"
