...
const BuyYoutubeViews = () => {
    ...
    return (
        <div className={styles.background} style={{ background: "url('/youtubeBg.png') no-repeat 100%  ", backgroundSize: 'cover' }}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Buy YouTube views from MakeTop for your video or profile. Get unlimited high-quality packages with payment by crypto or credit card. No password and risk" />
                <meta name="og:description" content="Buy YouTube views from MakeTop for your video or profile. Get unlimited high-quality packages with payment by crypto or credit card. No password and risk" />
                <meta property="og:locale" content="en_US" />
                <meta property="og:type" content="article" />
                <meta property="og:title" content="Buy YouTube Views with 100% Guarantee - MakeTop" />
                <meta property="title" content="Buy YouTube Views with 100% Guarantee - MakeTop" />
                <meta name="twitter:card" content="summary" />
                <meta name="twitter:description" content="Buy YouTube Views from MakeTop. Instant delivery, real views and friendly 24/7 customer support. Try us today." />
                <meta name="twitter:title" content="Buy YouTube Views From The world's #1 Site (2022)- maketop" />
                <meta name="twitter:title" content="Best Site to Buy YouTube Views (Instant &amp; Automatic)" />
                <meta name="twitter:site" content="@StormlikesN" />
                <meta property="og:url" content="https://maketop.io/buy-youtube-views" />
                    ...
                    <Layer type="youtube">
                        <div className={`container`}>
                            ...
                            <div className={styles.phone}>
                                <img src="/youtubePhoto.png" alt="buy youtube views" className={styles.youtubeImg} />
                                <div className={buyLikesStyles.mainTitle}>
                                    ...
                                    <ButtonComponent text={'Leave Feedback'} type={'youtube'}
                                        onClick={() => router.push("/")}
                                    />
                                </div>
                            </div>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 0 }}>
                                ...
                                <div className={buyLikesStyles.buyLikes_item_container}>
                                    ...
                                    {additionalPrice?.map((item, index) => <BuyLikes key={item[0]} likes={item[0]} newPrice={item[1]}
                                        text="Real YouTube Views" type={"youtube"}
                                        id={"YVIEWS"}
                                        onClick={() => {

                                            router.push({
                                                pathname: '/buy-youtube-views',
                                                query: { service: 'Views', counts: item[0], system: "YouTube", priceValue: item[1] },
                                            })
                                            setIsOpen(true)
                                        }} />)}
                            ...
                            <div className={buyLikesStyles.reviews_container}>
                                {comment && <ReviewsGenerator type="youtube" comment={comment} />}
                                <OwnComment type="youtube" service="Views" />
                                {isReviewButtonPress && <ModalReview open={isReviewButtonPress} setOpen={setIsReviewButtonPress} type="youtube" service="Views" />}
                                <span className={buyLikesStyles.ownHiddenButton}><ButtonComponent text={'Leave comment'} type={'youtube'}
                            ...
                            <div className={infoStyles.info_block}>
                                ...
                                {readTextMore && <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.
                                    ...
                                    nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel
                                    augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus.</p>}
                                <a style={{ color: "#FF0933", textDecoration: "underline" }} onClick={() => setReadTextMore(!readTextMore)}>{readTextMore ? "Close" : "Read more"}</a>
                            </div>
                        </div>
                    </Layer>
                </div>
