    ...
    return (
        <div className={styles.background} style={{ background: "url('instagramBg.png') no-repeat 100%  ", backgroundSize: 'cover' }}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Buy Instagram Comments with cheapest instant delivery to your profile. High rated comments and 100% quality. Simple payment by crypto or credit card" />
                <meta name="og:description" content="Buy Instagram Comments with cheapest instant delivery to your profile. High rated comments and 100% quality. Simple payment by crypto or credit card" />
                <meta property="og:locale" content="en_US" />
                <meta property="og:type" content="article" />
                <meta property="og:title" content="Buy Instagram Comments Guaranteed by MakeTop #1 since 2017" />
                <meta property="title" content="Buy Instagram Comments Guaranteed by MakeTop #1 since 2017" />
                <meta name="twitter:card" content="summary" />
                <meta name="twitter:description" content="Buy Instagram comments from MakeTop. Instant delivery, real comments and friendly 24/7 customer support. Try us today." />
                <meta name="twitter:title" content="Buy Instagram Comments From The world's #1 Site (2022)- maketop" />
                <meta name="twitter:site" content="@StormlikesN" />
                <meta property="og:url" content="https://maketop.io/buy-instagram-comments" />
                <link rel="canonical" href="https://maketop.io/buy-instagram-comments" />
            </Head>
                    ...
                    <Layer type="link">
                        <div className={`container`}>
                            ...
                            <div className={styles.phone}>
                                <img src="/buyLikesPhoto.png" alt="Buy Instagram Comments" className={styles.instagramImg} />
                            ...
                            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                                ...
                                <div className={buyLikesStyles.buyLikes_item_container}>
                                    ...
                                    {price?.Comments?.plans.map((item, index) => <BuyLikes key={item?.count} likes={item?.count} newPrice={item?.price}
                                        color="#285FFF" text="Real Instagram Comments" type={"instagram"}
                                        id={"COMMENTS"}
                                        onClick={() => {
                                            router.push({
                                                pathname: '/buy-instagram-comments',
                                                query: { service: 'Comments', counts: item?.count, system: "Instagram", priceValue: item?.price },
                                            })
                                            setIsOpen(true)
                            ...
                            <div className={buyLikesStyles.reviews_container}>
                                ...
                                {isReviewButtonPress && <ModalReview open={isReviewButtonPress} setOpen={setIsReviewButtonPress} type="instagram" service="Comments" />}
