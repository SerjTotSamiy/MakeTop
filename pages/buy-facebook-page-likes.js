    ...
    return (
        <div className={styles.background} style={{background:"url('facebookBg.png') no-repeat  100%  ",backgroundSize:'cover'}}>
            <Head>
                ...
                <title>MakeTop</title>
                <meta name="description" content="Buy Facebook page likes is a good way to get popular on social media. Easy payment by crypto or card. High-quality likes and safety service. Go try"/>
                <meta name="og:description" content="Buy Facebook page likes is a good way to get popular on social media. Easy payment by crypto or card. High-quality likes and safety service. Go try"/>
                <meta property="og:locale" content="en_US"/>
                <meta property="og:type" content="article"/>
                <meta property="og:title" content="Buy Facebook Page Likes - Only 2 Steps to Result - 100% Work"/>
                <meta property="title" content="Buy Facebook Page Likes - Only 2 Steps to Result - 100% Work"/>
                ...
                <meta name="twitter:title" content="Buy Facebook page likes From The world's #1 Site (2022)- maketop"/>
                <meta property="og:url" content="https://maketop.io/buy-facebook-page-likes"/>
                <link rel="canonical" href="https://maketop.io/buy-facebook-page-likes"/>
            </Head>
                ...
                <Layer type="facebook">
                    <div className={`container`}>
                        ...
                        <div className={styles.phone}>
                            <img src="/facebookImg1.svg" alt="buy facebook page likes"  className={styles.facebookImg1}/>
                            <img src="/facebookImg2.svg" alt="get facebook page likes"  className={styles.facebookImg2}/>
                            <img src="/facebookImg3.svg" alt="buy more facebook page likes"  className={styles.facebookImg3}/>
                            <img src="/facebookImg4.svg" alt="get real facebook page likes"  className={styles.facebookImg4}/>
